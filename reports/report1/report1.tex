...
\begin{itemize}
  \item \textbf{Stałe czasy trwania faz.} Okresy inkubacji i~zakaźności
        ...
        krzywe epidemiczne.
  \item \textbf{Brak modelu pojemności służby zdrowia.} Węzły zdrowotne
        istnieją, lecz nie~mają ograniczonej pojemności. Dodanie progu
        przeciążenia szpitali i~miary ,,osobodni ponad pojemnością''
        wzmocniłoby argument o~,,spłaszczaniu krzywej''.
...
\begin{enumerate}
  ...
  \item \textbf{Superspreaderzy podnoszą szczyt, lecz attack rate maskuje
        ...
        (zasada 80/20~\cite{lloyd2001realistic}).
